...
st.set_page_config(page_title="AKYLMAN", page_icon="🇰🇬", layout="wide")
...
MEMORY_FILE = akylnam_experience.txt"
...
if prompt := st.chat_input("Спросите PULSAR-X..."):
    ...
    with st.chat_message("assistant"):
        ...
        system_msg = (
            f"Ты — AKYLMAN, созданный Исануром. Тебя создали в школе Акылман находящаяся в Кыргызстане. "
